...
void runSystemPOST() {
    ...
    // TODO 4.1: Mostrar la cabecera visual
    showBootHeader();

    // TODO 4.2: Probar secuencialmente los 4 subsistemas
    ...
    // TODO 4.3: Concluir la rutina mostrando la barra final
    showSystemReady();
}
...
void setup() {
    ...
    if (total > 0 && initDisplay()) {
        ...
        Serial.println("[ERROR] Fallo en la inicialización de hardware I2C o Pantalla.");
    }
}
